    ...
    <header className="fixed top-0 left-0 w-full border-b border-white-a08 backdrop-blur-[12px]">
      <Container className="flex h-navigation-height">
        ...
        >
          ...
          >
            ...
            >
              ...
              <li>
                <Link href="/business" className="md:hidden lg:block">
                  Business
                </Link>
              </li>
              <li>
                <Link href="/support" className="md:hidden lg:block">
                  Support
                </Link>
              </li>
            </ul>
        ...
        <div className="ml-auto h-full flex items-center">
          <span className=" text-sky-700 text-sm mr-0" href="/">
            ({items.length})
          </span>
          ...
          <Button
            href="#"
            onClick={() =>
              setCartSliderIsOpen((open) => !open) & toast.success(`Processed to checkout`)
            }
          >
            Cart
          </Button>
