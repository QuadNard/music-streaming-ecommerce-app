...
// const Highlight = ({ children, className }) => <span className={classNames("highlight", className)}>{children}</span>
export const Button = ({ children, href, variant, size, ...props }) => {
  const classes = buttonClasses({ variant, size, href, className: props.className });
